...
- Each site can display that opt-in UI immediately, after a configurable scroll depth (1–100%), or on a configurable page view (1–100). Page-view progress is stored per site in the visitor's browser; existing sites default to immediate display.

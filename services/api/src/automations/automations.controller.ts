...
export class AutomationsController {
  ...
  @Post()
  async createAutomation(@Body() dto: CreateAutomationDto): Promise<{ success: true; data: unknown }> {
    const automation = await this.automationsService.createAutomation(dto);
  ...
  @Patch(":id")
  async updateAutomation(@Param("id") id: string, @Body() dto: UpdateAutomationDto): Promise<{ success: true; data: unknown }> {
    const automation = await this.automationsService.updateAutomation(id, dto);
    return { success: true, data: automation };
  }

  @Delete(":id")
  async deleteAutomation(@Param("id") id: string): Promise<{ success: true; data: { deleted: true } }> {
    await this.automationsService.deleteAutomation(id);
